...
This dependency reimplements the native [`String.prototype.toUpperCase()`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/String/toUpperCase) method. It is supported by all modern browsers and Node.js versions since ES6 (2015).
